...
class FillPermissionsForBiodatum extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBiodatum constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.biodatum',
            'admin.biodatum.index',
            'admin.biodatum.create',
            'admin.biodatum.show',
            'admin.biodatum.edit',
            'admin.biodatum.delete',
            'admin.biodatum.bulk-delete',
        ]);
