...
<head>
    ...
    <title>{{$biodata->nama}} - My Portfolio</title>
...
<body id="page-top">
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">MY PORTFOLIO</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading mb-0">Hallo I'm {{$biodata->nama}}</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="pre-wrap masthead-subheading font-weight-light mb-0">{{$skill->nama_skill}}
            </p>
        </div>
    </header>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-5 col-lg-3 mb-4">
                    <div class="portfolio-item mx-auto" data-toggle="modal"
                        data-target="#portfolioModal{{$project->id}}">
                        <div
                            class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i
                                    class="fas fa-plus fa-3x"></i></div>
                        </div>
                        <div class="card text-center bg-dark text-white" style="">
                            <div class="card-body">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2 class="portfolio-modal-title text-secondary mb-0">{{$project->judul}}</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <p class="mb-5">{!!$project->keterangan!!}
                                </p>
                                <a href="{{$project->link}}" class="btn btn-primary" <i
                                    class="fas fa-plus fa-fw"></i>Source Code</button></a>
                                <button class="btn btn-danger" href="#" data-dismiss="modal"><i
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 ml-auto">
                    <p class="pre-wrap lead text-center">{!!$biodata->keterangan!!}</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="lead font-weight-bold">{{$biodata->no_hp}}</div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="text-muted">Email</div><a class="lead font-weight-bold"
                            href="mailto:name@example.com">{{$biodata->email}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="pre-wrap lead mb-0">{{$biodata->alamat}}</p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="pre-wrap lead mb-0">{{$biodata->keterangan}}</p>
                </div>
            </div>
        </div>
    </footer>
